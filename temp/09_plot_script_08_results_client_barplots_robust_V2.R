# ==============================================================================
# IADB - 09 Plot Script 08 PAP/SAP Results (ROBUST CLIENT VERSION) --------------
# Author: Cedric Antunes (Evaluasi)
# Date: June 2026
#
# Purpose:
#   Convert Script 08 PAP/SAP coefficient and multiplicity outputs into
#   client-facing vertical barplots with 95% confidence intervals.
#
...
#   - No raw p < 0.10 color rule is used in this client-facing script.
#
# Evaluasi visual rule requested:
...
if (length(missing_files) > 0) {
  stop(
    "Missing required Script 08 output file(s):\n",
...
# ------------------------------------------------------------------------------
# 5. Primary confirmatory plots: PAP-adjusted significance at alpha = 0.05 ------
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# 6. Appendix/sensitivity plot: channel effects across samples ------------------
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# 7. Appendix/sensitivity plot: channel effects across model specifications -----
# ------------------------------------------------------------------------------
